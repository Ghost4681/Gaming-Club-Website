...
function Cover() {
    return (
        <div className='flex flex-col justify-center items-center justify-items-center content-center bg-gray-200'>
            ...
            <div className='w-3/4 h-24 -mt-21 stats-card z-20 rounded-3xl shadow-2xl drop-shadow-2xl flex flex-row justify-around content-around items-center'>
                <div>
                    <h1 className='text-gray-200 text-3xl uppercase pt-2'>minecraft</h1>
                </div>
                <div>
                    <h2 className='text-gray-300 text-lg pt-2'>4th September 2022 | 22:00 IST</h2>
                </div>
